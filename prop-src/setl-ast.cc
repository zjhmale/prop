...
#line 36 "setl-ast.pcc"
           f << ((Sig_IDsig *)s)->IDsig; 
#line 36 "setl-ast.pcc"
            } break;
         case a_Sig::tag_DOTsig: {
#line 37 "setl-ast.pcc"
...
#line 66 "setl-ast.pcc"
     f << "skip;"; 
#line 66 "setl-ast.pcc"
   }
}
#line 83 "setl-ast.pcc"
#line 83 "setl-ast.pcc"
...
#line 108 "setl-ast.pcc"
 f << b->pat;
   if (b->guard != NOexp) f << " | " << b->guard;
   f << " <- " << b->exp;
   
#line 111 "setl-ast.pcc"
}
#line 112 "setl-ast.pcc"
#line 112 "setl-ast.pcc"
...
#line 125 "setl-ast.pcc"
#line 125 "setl-ast.pcc"

   return f;
}
#line 128 "setl-ast.pcc"
/*
------------------------------- Statistics -------------------------------
