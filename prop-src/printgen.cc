...
#line 56 "printgen.pcc"
#line 59 "printgen.pcc"
{
   if (datatype_ty) {
...
#line 59 "printgen.pcc"
   ...
   if (arity > 1) C.pr("%^switch (%U)%^{%+", IDexp(
#line 91 "printgen.pcc"
#line 91 "printgen.pcc"
...
{  
#line 115 "printgen.pcc"
#line 126 "printgen.pcc"
{
   if (cons) {
#line 117 "printgen.pcc"
    cons_arg_ty = cons->ty == NOty ? NOty : apply_ty(cons->cons_ty,tys);
      if (cons->print_formats == 
#line 118 "printgen.pcc"
#line 118 "printgen.pcc"
      nil_1_
#line 118 "printgen.pcc"
#line 118 "printgen.pcc"
                        ...
                        if (((Ty_TYCONty *)_V1)->_2) {
                           if (((Ty_TYCONty *)_V1)->_2->_2) {
                              if (((Ty_TYCONty *)_V1)->_2->_2->_2) {
                                 L3:; 
#line 145 "printgen.pcc"
                                Tys ts;
                                 	  fmt = 
#line 146 "printgen.pcc"
#line 146 "printgen.pcc"
                                 list_1_(TERMsym(')'))
#line 146 "printgen.pcc"
#line 146 "printgen.pcc"
...
#line 156 "printgen.pcc"
                       Tys ts;
                        	  fmt = 
#line 157 "printgen.pcc"
#line 157 "printgen.pcc"
                        list_1_(TERMsym(')'))
#line 157 "printgen.pcc"
#line 157 "printgen.pcc"
...
#line 217 "printgen.pcc"
       int len = strlen(((ProductionSymbol_TERMSTRINGsym *)f)->TERMSTRINGsym);
         	    if (len == 1) 
         	    {  C.pr("%^strm__ << '%s';",((ProductionSymbol_TERMSTRINGsym *)f)->TERMSTRINGsym);
                     } else if (len == 3 && ((ProductionSymbol_TERMSTRINGsym *)f)->TERMSTRINGsym[0] == '"' && ((ProductionSymbol_TERMSTRINGsym *)f)->TERMSTRINGsym[2] == '"' && 
         		       ! isalnum(((ProductionSymbol_TERMSTRINGsym *)f)->TERMSTRINGsym[1]))
...
#line 227 "printgen.pcc"
         } break;
      case a_ProductionSymbol::tag_NONTERMsym: {
#line 211 "printgen.pcc"
...
#line 252 "printgen.pcc"
            ...
            case '[': {
#line 229 "printgen.pcc"
             C.pr("%^strm__ << '%c';", (int)cons->name[1]); 
#line 229 "printgen.pcc"
            } break;
            case ']': {
#line 231 "printgen.pcc"
...
#line 257 "printgen.pcc"
                
                  	    if (N == 1)
                  	    {  gen_print_field(C, exp, ty); }
                  	    else if (label_list == 
#line 260 "printgen.pcc"
#line 260 "printgen.pcc"
                  nil_1_
#line 260 "printgen.pcc"
#line 260 "printgen.pcc"
