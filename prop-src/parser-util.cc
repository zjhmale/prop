...
{  return 
#line 116 "parser-util.pcc"
#line 116 "parser-util.pcc"
LISTpat(lookup_cons(cons), lookup_cons(nil), ps, p)
#line 120 "parser-util.pcc"
#line 120 "parser-util.pcc"
; 
}
Pat mkvecpat
...
{  Used::vector = true;
   return 
#line 125 "parser-util.pcc"
#line 125 "parser-util.pcc"
VECTORpat(lookup_cons(a), len, array, ps, flex1, flex2)
#line 131 "parser-util.pcc"
#line 131 "parser-util.pcc"
;
}
...
#line 146 "parser-util.pcc"
{
   if (a) {
      switch (a->tag__) {
         case a_Exp::tag_IDexp: {
            if (
#line 145 "parser-util.pcc"
...
#line 195 "parser-util.pcc"
#line 201 "parser-util.pcc"
{
   char _V1 = id[0];
   if (e) {
#line 201 "parser-util.pcc"
...
#line 201 "parser-util.pcc"
      ...
      switch (_V1) {
         ...
         case '$': {
            L2:; 
#line 197 "parser-util.pcc"
          error ("%Lpattern variable '%s' has no binding at this point\n", id); 
            return NOexp;
            
#line 199 "parser-util.pcc"
         } break;
         default: {
#line 200 "parser-util.pcc"
           return IDexp(id); 
#line 200 "parser-util.pcc"
         }
      }
