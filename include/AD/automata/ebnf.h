...
public:
   ...
   inline friend int boxed(const a_EBNF * x) { return 1; }
   inline friend int untag(const a_EBNF * x) { return x->_tag_; }
   ////////////////////////////////////////////////////////////////////////////
   // Downcasting functions for EBNF
   ////////////////////////////////////////////////////////////////////////////
   inline friend EBNF_ebnf_or * _ebnf_or(EBNF _x_) { return (EBNF_ebnf_or *)_x_; }
   inline friend EBNF_ebnf_dot * _ebnf_dot(EBNF _x_) { return (EBNF_ebnf_dot *)_x_; }
   inline friend EBNF_ebnf_star * _ebnf_star(EBNF _x_) { return (EBNF_ebnf_star *)_x_; }
   inline friend EBNF_ebnf_plus * _ebnf_plus(EBNF _x_) { return (EBNF_ebnf_plus *)_x_; }
   inline friend EBNF_ebnf_terminal * _ebnf_terminal(EBNF _x_) { return (EBNF_ebnf_terminal *)_x_; }
   inline friend EBNF_ebnf_nonterminal * _ebnf_nonterminal(EBNF _x_) { return (EBNF_ebnf_nonterminal *)_x_; }
   inline friend EBNF_ebnf_action * _ebnf_action(EBNF _x_) { return (EBNF_ebnf_action *)_x_; }
   inline friend EBNF_syntactic_predicate * _syntactic_predicate(EBNF _x_) { return (EBNF_syntactic_predicate *)_x_; }
   inline friend EBNF_semantic_predicate * _semantic_predicate(EBNF _x_) { return (EBNF_semantic_predicate *)_x_; }
#line 45 "ebnf.ph"
