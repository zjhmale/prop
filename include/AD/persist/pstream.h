...
//  from the classes ios, istream, ostream, or iostream since the
...
//  work.  
//
//  Rather we allow any base classes of istream and ostream to be attached
