...
class StringImpl {
   ...
   inline void dec_ref() { if (--ref == 0) delete this; }
   inline void inc_ref() { ++ref; }
...
public:
   inline ~SubString() { if (--impl->ref == 0) delete impl; }
   ...
   inline char   operator [] (int i) const { return impl->string[start+i]; }
   inline char&  operator [] (int i)       { return impl->string[start+i]; }
};
...
public:
   ...
   inline  String(const String& s)     // e.g. String s1 = s2;
      : impl(s.impl) { impl->inc_ref(); }
   inline ~String() { impl->dec_ref(); }

   ///////////////////////////////////////////////////////////////////////
   // Conversion
   ///////////////////////////////////////////////////////////////////////
   inline operator const char * () const { return impl->string; }
   inline const char * str() const       { return impl->string; }
  
   ///////////////////////////////////////////////////////////////////////
   // Assignment 
   ///////////////////////////////////////////////////////////////////////
   inline String& operator = (const String& s)
   {  if (this != &s) { s.impl->inc_ref(); dec_ref(); impl = s.impl; }
      return *this;
   }
   ...
   // Selectors
   ///////////////////////////////////////////////////////////////////////
   inline size_t length()   const          { return impl->len; }
   inline size_t size()     const          { return impl->len; }
   inline size_t capacity() const          { return impl->capacity; }
   inline Bool   is_empty() const          { return impl->len == 0; }
   inline Bool   is_full()  const          { return false; }
   inline char   operator [] (int i) const { return impl->string[i]; }
   inline char&  operator [] (int i)       { return impl->string[i]; }
   ...
   // Comparisons
   ///////////////////////////////////////////////////////////////////////
   inline friend Bool operator == (const String& a, const String& b) { return a.compare(b) == 0; }
   inline friend Bool operator == (const String& a, const char * b)  { return a.compare(b) == 0; }
   inline friend Bool operator == (const char * a, const String& b)  { return b.compare(a) == 0; }
   inline friend Bool operator != (const String& a, const String& b) { return a.compare(b) != 0; }
   inline friend Bool operator != (const String& a, const char * b)  { return a.compare(b) != 0; }
   inline friend Bool operator != (const char * a, const String& b)  { return b.compare(a) != 0; }
   inline friend Bool operator > (const String& a, const String& b)  { return a.compare(b) > 0; }
