...
template<class T>
   ...
   public:
      ...
      //////////////////////////////////////////////////////////////////////
      Bag(int count = 0) : tally(count) {}        // make an empty bag
     ~Bag() {}                                    // destroy a bag
      ...
      //////////////////////////////////////////////////////////////////////
      inline virtual int  size()     const { return tally; }
      inline virtual Bool is_empty()  const { return tally == 0; }
      inline virtual Bool is_full()   const { return tally == capacity(); }
      ...
      inline virtual Ix   insert(const T& e) { return insert(e,1); }
      inline virtual Bool remove(const T& e) { return remove(e,1); }
      virtual Ix   insert(const T& e, int count) = 0;
      virtual Bool remove(const T& e, int count) = 0;
      Bag& Union      (const Bag&);
