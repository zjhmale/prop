...
template <class T, class S>
   ...
   public:
     ...
     ~StackableCollection() {}
      ...
      virtual T& top() const { return stack.top(); }

      ////////////////////////////////////////////////////////////////
      //  Mutators
      ////////////////////////////////////////////////////////////////
      virtual void clear()            { return stack.clear(); }
      virtual Ix   insert(const T& e) { stack.push(e); return &top(); }
      virtual Bool remove(const T& e) { should_not_implement("remove"); }
      virtual void push(const T& e)   { stack.push(e); }
      virtual T&   pop()              { return stack.pop(e); }
      ...
      //  Other
      ////////////////////////////////////////////////////////////////
      const char * myName() const { return "StackableCollection"; }
   };
