...
template<class K, class V, class HashTable>
   ...
   public:
     ...
     ~HashMap() {} 
      ...
      inline int   capacity()           const { return table.capacity(); }
      inline Bool  is_empty()           const { return table.is_empty(); }
      inline Bool  is_full ()           const { return table.is_full(); }
      inline Bool  contains(const K& k) const { return table.contains(k); }
      ...
      inline Ix lookup (const K& k) const { return table.lookup(k); }
      ...
      inline Ix   insert (const K& k, const V& v) { return table.insert(k,v); }
      inline Bool remove (const K& k)             { return table.remove(k); }

      /////////////////////////////////////////////////////////////////////////
      // Iteration
      /////////////////////////////////////////////////////////////////////////
      inline Ix       first()     const { return table.first(); } 
      inline Ix       next(Ix i)  const { return table.next(i); }
      inline const K& key(Ix i)   const { return table.key(i); }
      inline const V& value(Ix i) const { return table.value(i); }
      inline V&       value(Ix i)       { return table.value(i); }

      /////////////////////////////////////////////////////////////////////////
      // Class name
      /////////////////////////////////////////////////////////////////////////
      const char * myName() const { return "HashMap"; }
   };
